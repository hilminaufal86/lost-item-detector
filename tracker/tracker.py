...
class Tracker:
    ...
    def update(self, detections):
        ...
        for track_idx, detection_idx in matches:
            self.tracks[track_idx].update(self.kf, detections[detections_idx])
    ...
    def _match(self, detections):
        ...
        # split track set into confirmed and uncomfirmed
    ...
    def _initiate_track(self, detection):
        ...
        self.tracks.append(Track(detection.class_id, mean, covariance, self.next_id, self.n_init, self.max_age, detection.feature))
        self.next_id += 1